...
namespace PlannerApp.Shared.Services
{
    public class PlansService
    {
        ...
        /// <summary>
        /// Retrive all the plans from the API with pagination
        /// </summary>
        ...
        /// </summary>
        /// <param name="model">object represents the plan to be edited</param>
        /// <returns></returns>
        ...
        /// </summary>
        /// <param name="model">ID of the plan to be deleted</param>
        /// <returns></returns>
